...
# %%
hugging_face_model_id = "google/gemma-3-4b-it"  # google/gemma-3-4b-it
...
checkpoints_dir = 'preference_class_gemma_model_4b_fix_1'  # More descriptive name
...
# %%
output_dir = f'preference_class_gemma_4b_fix_1'
...
# %%
output_dir = 'preference_class_gemma_4b_fix_1'
hugging_face_model_id = "google/gemma-3-4b-it"  # gemma-3-4b-it
gpu_device = 'cuda:0'
