...
checkpoints_dir = 'preference_class_gemma_model_1b_fix_1'  # More descriptive name
...
# %%
output_dir = f'preference_class_gemma_1b_fix_1'
...
# %%
output_dir = 'preference_class_gemma_1b_fix_1'
