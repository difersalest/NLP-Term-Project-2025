...
# %%
hugging_face_model_id = "google/gemma-3-12b-it-qat-q4_0-unquantized"  # google/gemma-3-4b-it
...
checkpoints_dir = 'preference_class_gemma_model_6'  # More descriptive name
...
training_args = TrainingArguments(
    ...
    per_device_train_batch_size=8,  # Batch size per device, 8 in the beginning
    ...
    gradient_accumulation_steps=4,  # 4 before
    fp16=False,
    bf16=True,
    warmup_ratio=0.05,
...
# %%
output_dir = f'preference_class_gemma_6'
...
# %%
output_dir = 'preference_class_gemma_6'
hugging_face_model_id = "google/gemma-3-12b-it-qat-q4_0-unquantized"  # gemma-3-4b-it
gpu_device = 'cuda:0'
